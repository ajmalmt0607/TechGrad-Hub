				...
				<div className="flex justify-between items-center h-16">
						...
						<nav className="hidden md:flex space-x-4">
							...
							<div className="relative">
								...
								{openDropdown === "instructor" && (
									<div className="absolute left-0 mt-2 w-48 bg-gray-100 rounded-md shadow-lg py-2 z-20">
										<Link
					...
					<div className="flex items-center space-x-4">
						...
						<div className="relative">
							...
							{openDropdown === "cart" && (
								<div className="absolute right-0 mt-2 w-48 bg-gray-100 rounded-md shadow-lg py-2 z-20">
